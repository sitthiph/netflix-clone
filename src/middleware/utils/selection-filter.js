export default function selectionFilter({series, films}) {
    return {
        ...
        films: [
            {title: 'Drama', films: series.filter((item) => item.genre === 'drama')},
            {title: 'Thriller', films: series.filter((item) => item.genre === 'thriller')},
            {title: 'Children', films: series.filter((item) => item.genre === 'children')},
            {title: 'Suspense', films: series.filter((item) => item.genre === 'suspense')},
